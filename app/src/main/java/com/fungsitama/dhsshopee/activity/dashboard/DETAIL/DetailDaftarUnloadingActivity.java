...
import com.fungsitama.dhsshopee.activity.dhs.Unloading.DetailListBarcodeUnloadingActivity;
...
public class DetailDaftarUnloadingActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_daftar_unloading);

        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Daftar Bongkar Muat Barang");
        ...
        this.mAdapter = new ListDaftarLoadingAdapter(listPengirimanModels, this, new ListDaftarLoadingAdapter.Onclick() {
            ...
            public void onEvent(ListDaftarLoadingModel modelItem, int pos) {
                Intent intent = new Intent(DetailDaftarUnloadingActivity.this, ScanBarcodeUnloadingActivity.class);
            ...
            @Override
            public void onEvent(ListDaftarLoadingModel modelItem, int pos) {
                new SweetAlertDialog(DetailDaftarUnloadingActivity.this, SweetAlertDialog.WARNING_TYPE).setTitleText("Informasi")
            ...
            @Override
            public void onEvent(ListDaftarLoadingModel modelItem, int pos) {
                Intent intent = new Intent(DetailDaftarUnloadingActivity.this, DaftarLoadingDetailActivity.class);
                intent.putExtra("id", listPengirimanModels.get(pos).getId());
                intent.putExtra("noTrans", listPengirimanModels.get(pos).getTransNumber());
                intent.putExtra("status", listPengirimanModels.get(pos).getStatus());
                startActivity(intent);
                //Toast.makeText(DetailDaftarUnloadingActivity.this, "Klik Detail", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void getDaftarUnloading() {
        swipeRefreshLayout.setRefreshing(true);
        ...
        JsonObjectRequest r3 = new JsonObjectRequest(1, sb.toString(), jSONObject, new Response.Listener<JSONObject>() {
            public void onResponse(JSONObject jSONObject) {
                ...
                try {
                    ...
                    new SweetAlertDialog(DetailDaftarUnloadingActivity.this, SweetAlertDialog.SUCCESS_TYPE).setTitleText("Informasi")
                            .setContentText(msg)
                            .setConfirmText("Ok")
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                public void onClick(SweetAlertDialog sweetAlertDialog) {

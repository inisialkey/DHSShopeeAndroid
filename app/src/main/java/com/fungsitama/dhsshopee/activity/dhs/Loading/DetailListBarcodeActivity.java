...
public class DetailListBarcodeActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public ListBarcodeLoadingDetailAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Detail Barang "+ noTrans);
        ...
        this.mAdapter = new ListBarcodeLoadingDetailAdapter(listDataModel, this, new ListBarcodeLoadingDetailAdapter.Onclick() {
            @Override
            public void onEvent(ListBarcodeDetailModel modelItem, int pos) {
                /*Toast.makeText(DetailListBarcodeActivity.this, "Pindah ke gambar", Toast.LENGTH_SHORT).show();*/
                if (listDataModel.get(pos).getManual().equals("true")){
                    if (listDataModel.get(pos).getStatus().equals("Loading")){
                        Intent intent = new Intent(DetailListBarcodeActivity.this, DaftarGambarBarcodeManualActivity.class);
        ...
        }, new ListBarcodeLoadingDetailAdapter.Onclick() {
            @Override
            public void onEvent(ListBarcodeDetailModel modelItem, int pos) {
                String barCode = listDataModel.get(pos).getQrcode();

                new SweetAlertDialog(DetailListBarcodeActivity.this, SweetAlertDialog.WARNING_TYPE).setTitleText("Yakin akan hapus data ?")
                        .setConfirmText("Iya")
    ...
    private void getDaftarBarcodeLoading(int page) {
        ...
        //swipeRefreshLayout.setRefreshing(true);
        RequestQueue newRequestQueue = Volley.newRequestQueue(DetailListBarcodeActivity.this);
        ...
        JsonObjectRequest r3 = new JsonObjectRequest(1, sb.toString(), jSONObject, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                new SweetAlertDialog(DetailListBarcodeActivity.this, SweetAlertDialog.WARNING_TYPE).setTitleText("Informasi")
                        .setContentText(msg)
                        .setConfirmText("Ok")
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            public void onClick(SweetAlertDialog sweetAlertDialog) {

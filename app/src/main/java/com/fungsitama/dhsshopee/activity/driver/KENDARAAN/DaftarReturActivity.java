...
public class DaftarReturActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    FloatingActionButton btnTambahRetur;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_retur);

        title = getResources().getString(R.string.daftar_retur);
        ...
        btnTambahRetur = findViewById(R.id.btn_TambahRetur);
        ...
        this.mAdapter = new ListKendaraanAdapter(listPengirimanModels, this, new ListKendaraanAdapter.Onclick() {
            ...
            public void onEvent(ListPengirimanModel modelItem, int pos) {
                ...
                Intent intent = new Intent(DaftarReturActivity.this, DaftarReturDOActivity.class);
            ...
            public void onEvent(ListPengirimanModel modelItem, int pos) {
                ...
                //Toast.makeText(DaftarReturActivity.this, "status : "+ status, Toast.LENGTH_SHORT).show();

                updateStatusOtw(listPengirimanModels.get(pos).getId(), listPengirimanModels.get(pos).getStatus());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_go_home: {
                ...
                Intent intent = new Intent(DaftarReturActivity.this, NavMenuActivity.class);
                startActivity(intent);
                finish();
        ...
        JsonObjectRequest r3 = new JsonObjectRequest(1, sb.toString(), jSONObject, new Response.Listener<JSONObject>() {
            public void onResponse(JSONObject jSONObject) {
                try {
                    ...
                    spinKendaraan.setAdapter(new ArrayAdapter(DaftarReturActivity.this, android.R.layout.simple_list_item_1, alKendaraan));
    ...
    public void getTambahKendaraan(String nomorKendaraan){
        RequestQueue newRequestQueue = Volley.newRequestQueue(DaftarReturActivity.this);
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("codeVehicle", nomorKendaraan);
            jSONObject.put("retur", true);
        ...
        JsonObjectRequest r3 = new JsonObjectRequest(1, sb.toString(), null, new Response.Listener<JSONObject>() {
            public void onResponse(JSONObject jSONObject) {
                try {
                    ...
                    new SweetAlertDialog(DaftarReturActivity.this, 2).setTitleText("Informasi")
                            .setContentText(msg)
                            .setConfirmText("Ok")
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                new SweetAlertDialog(DaftarReturActivity.this, SweetAlertDialog.WARNING_TYPE).setTitleText("Informasi")
                        .setContentText(msg)
                        .setConfirmText("Ok")
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
    ...
    private void getListDataRetur() {
        ...
        //final String jSONObject2 = jSONObject.toString();
        StringBuilder sb = new StringBuilder();
        sb.append(ApiConfig.DaftarRetur);
        JsonObjectRequest r3 = new JsonObjectRequest(1, sb.toString(), jSONObject, new Response.Listener<JSONObject>() {
            public void onResponse(JSONObject jSONObject) {
                Date date1;
                try {
    ...
    private void updateStatusOtw(String id, String status){

        String xStatus;

        if (status.equals("Pick-Up Retur")){
            xStatus = "OTW Retur";
        }else if (status.equals("OTW Retur")){
            xStatus = "Retur";
        }else{
            xStatus = "OTW";
        }
        ...
        new SweetAlertDialog(DaftarReturActivity.this, SweetAlertDialog.WARNING_TYPE).setTitleText("Informasi")
                .setContentText("Yakin akan update Status ke " + xStatus +" ?")
                .setConfirmText("Ya")
                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                        ...
                        StringBuilder sb = new StringBuilder();
                        if (status.equals("OTW Retur")){
                            sb.append(ApiConfig.UpdateStatusRetur);
                        }else{

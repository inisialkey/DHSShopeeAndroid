...
import com.fungsitama.dhsshopee.activity.driver.KENDARAAN.DaftarNomorDOActivity;
...
public class DaftarLoadingActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mAdapter = new ListDaftarLoadingAdapter(listPengirimanModels, this, new ListDaftarLoadingAdapter.Onclick() {
            ...
            public void onEvent(ListDaftarLoadingModel modelItem, int pos) {
                ...
                String vid = listPengirimanModels.get(pos).getId();

                Log.d("TAG", "vid: " + vid);


                Intent intent = new Intent(DaftarLoadingActivity.this, ScanBarcodeLoadingActivity.class);
            ...
            @Override
            public void onEvent(ListDaftarLoadingModel modelItem, int pos) {
                new SweetAlertDialog(DaftarLoadingActivity.this, SweetAlertDialog.WARNING_TYPE).setTitleText("Informasi")
            ...
            @Override
            public void onEvent(ListDaftarLoadingModel modelItem, int pos) {
                //Toast.makeText(DaftarLoadingActivity.this, "Klik Detail", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(DaftarLoadingActivity.this, DaftarLoadingDetailActivity.class);
                intent.putExtra("id", listPengirimanModels.get(pos).getId());
                intent.putExtra("noTrans", listPengirimanModels.get(pos).getTransNumber());
        ...
        btnTambahKendaraan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DaftarLoadingActivity.this, TambahMuatBarangActivity.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_go_home: {
                ...
                Intent intent = new Intent(DaftarLoadingActivity.this, NavMenuActivity.class);
                startActivity(intent);
                finish();
        ...
        JsonObjectRequest r3 = new JsonObjectRequest(1, sb.toString(), jSONObject, new Response.Listener<JSONObject>() {
            public void onResponse(JSONObject jSONObject) {
                ...
                try {
                    ...
                    new SweetAlertDialog(DaftarLoadingActivity.this, SweetAlertDialog.SUCCESS_TYPE).setTitleText("Informasi")
                            .setContentText(msg)
                            .setConfirmText("Ok")
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                public void onClick(SweetAlertDialog sweetAlertDialog) {

...
import com.fungsitama.dhsshopee.model.ListDetailPenerimaanAgenModel;

import java.util.List;

public class ListDetailPenerimaanAgenAdapter extends RecyclerView.Adapter<ListDetailPenerimaanAgenAdapter.ViewHolder> {

    private List<ListDetailPenerimaanAgenModel> listNomorModels;
    private Context context;


    public ListDetailPenerimaanAgenAdapter(List<ListDetailPenerimaanAgenModel> listNomorModels, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        final ListDetailPenerimaanAgenModel listdata = listNomorModels.get(position);

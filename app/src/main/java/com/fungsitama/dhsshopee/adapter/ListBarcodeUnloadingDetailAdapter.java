...
public class ListBarcodeUnloadingDetailAdapter extends RecyclerView.Adapter<ListBarcodeUnloadingDetailAdapter.ViewHolder> {
    ...
    public ListBarcodeUnloadingDetailAdapter(List<ListBarcodeDetailModel> listDetailNomorDOModels, Context context, Onclick onclick) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_list_barcode_unloading_detail, viewGroup, false);
